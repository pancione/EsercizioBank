package com.panc.bank.action.letturaSaldo.out;

public class LetturaSaldoOut {
	...
	public String toString() {
		...
		builder.append("LetturaSaldoOut [accountId=");
		builder.append(accountId);
		builder.append(", iban=");
		builder.append(iban);
		builder.append(", abiCode=");
		builder.append(abiCode);
		builder.append(", cabCode=");
		builder.append(cabCode);
		builder.append(", countryCode=");
		builder.append(countryCode);
		builder.append(", internationalCin=");
		builder.append(internationalCin);
		builder.append(", nationalCin=");
		builder.append(nationalCin);
